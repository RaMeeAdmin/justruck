...
class GetParcelListRouteWiseAPI
{
  static Future<List<BeanParcelDetails>> retrieveParcelListForRoute(String routeId) async
  {
    List<BeanParcelDetails> listParcel = List.empty(growable: true);
    listParcel.clear();

    String url = URLHelper.wsRouteWiseListParcel;

    var client = http.Client();

    try
    {
      print("Getting Route Wise Parcel List => "+ url);
