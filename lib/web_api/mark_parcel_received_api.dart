...
class MarkParcelReceivedAPI
{
  static Future<BeanResponse> markParcelAsReceived(String strParcelId) async
  {
    BeanResponse beanResponse = BeanResponse(false, "", "");

    String url = URLHelper.wsMarkParcelReceived;

    var client = http.Client();

    try
    {
      print("Marking Parcel "+strParcelId+" as Received => "+url);
