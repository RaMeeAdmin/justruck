...
class SearchCustomerDetailsAPI
{
  static Future<List<BeanCustomerDetails>> searchForCustomer(String pattern) async
  {
    List<BeanCustomerDetails> listCustomerDetails = List.empty(growable: true);
    listCustomerDetails.clear();

    String url = URLHelper.wsSearchCustomer;

    var client = http.Client();

    try
    {
      print("Getting User Details => "+ url);
